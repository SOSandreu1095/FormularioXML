...
function gestionarXml(dadesXml) {
    ...
    var nodosSelect = xmlDoc.evaluate(xpath, xmlDoc, null, XPathResult.ANY_TYPE, null);
    ponerDatosSelect(tituloSelect, "q7", nodosSelect, 0);
    //ANSWER
    ...
    var xpath = "/questions/question[@id='jklm_008']/option";

    var nodosSelect = xmlDoc.evaluate(xpath, xmlDoc, null, XPathResult.ANY_TYPE, null);
    ponerDatosSelect(tituloSelect, "q8", nodosSelect, 1);
    //ANSWER
    ...
    var xpath = "/questions/question[@id='jklm_009']/option";

    var nodosMult = xmlDoc.evaluate(xpath, xmlDoc, null, XPathResult.ANY_TYPE, null);
    ponerDatosMultiple(tituloMultiple, "q9", nodosMult, 2);
    //ANSWER
    ...
    var xpath = "/questions/question[@id='jklm_010']/option";

    var nodosMult = xmlDoc.evaluate(xpath, xmlDoc, null, XPathResult.ANY_TYPE, null);
    ponerDatosMultiple(tituloMultiple, "q10", nodosMult, 3);
    //ANSWER
...
function ponerDatosSelect(tituloSelect, IDposicion, opciones, numSelect) {
    ...
    var result = opciones.iterateNext();
